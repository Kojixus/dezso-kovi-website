...
const leadershipPrimary = [
  {
    ...
    bullets: [
      "Built a WBS with 24 work packages.",
      "Developed a $137,700 budget (School Project Restrictions) with time-phased estimates for 3,610 labor hours.",
      ...
      "Developed a measurable project objectives + success criteria (schedule, budget, compliance, QA, and logistics performance).",
